    ...
    static private function runSQL() {
        ...
        if ($runConfig == 0) {
          ...
          $query = "INSERT INTO  `" . wpjobportal::$_db->prefix . "wj_portal_config` (`configname`, `configvalue`, `configfor`, `addon`) VALUES
              ...
              ('cron_job_alert_key', '', 'wpjobportal', 'cronjob'),
              ...
              ('versioncode', '2.5.8', 'default', NULL),
        ...
        $query = " INSERT INTO  `" . wpjobportal::$_db->prefix . "wj_portal_fieldsordering` (`id`, `field`, `fieldtitle`, `ordering`, `section`, `is_section_headline`, `placeholder`, `description`, `fieldfor`, `published`, `isvisitorpublished`, `sys`, `cannotunpublish`, `required`, `isuserfield`, `userfieldtype`, `userfieldparams`, `search_user`, `search_visitor`, `search_ordering`, `cannotsearch`, `showonlisting`, `cannotshowonlisting`, `depandant_field`, `readonly`, `size`, `maxlength`, `cols`, `rows`, `j_script`, `visible_field`, `visibleparams`) VALUES
            ...
            (26, 'startpublishing', 'Start Publishing', 16, '', 0, NULL, NULL, 2, 1, 1, 0, 1, 1, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (27, 'stoppublishing', 'Stop Publishing', 19, '', 0, 'Enter Data', '', 2, 1, 1, 0, 1, 1, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (28, 'city', 'City', 14, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 1, 1, NULL, 0, 1, 0, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (29, 'sendemail', 'Send Email', 20, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (30, 'sendmeresume', 'Send me Resume', 21, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (31, 'description', 'Description', 22, '', 0, NULL, NULL, 2, 1, 1, 0, 1, 1, 0, '', '', 0, 0, NULL, 1, 0, 0, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (32, 'qualifications', 'Qualifications', 23, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (33, 'prefferdskills', 'Prefered Skills', 24, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (34, 'agreement', 'Agreement', 25, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (35, 'filter', 'Filter', 26, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (36, 'emailsetting', 'Email Setting', 27, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (37, 'joblink', 'Redirect on apply', 28, '', 0, NULL, NULL, 2, 0, 0, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (38, 'tags', 'Tags', 15, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 1, 1, NULL, 0, 0, 0, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (39, 'metadescription', 'Meta Description', 29, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (40, 'metakeywords', 'Meta Keywords', 17, '', 0, NULL, NULL, 2, 1, 1, 0, 0, 0, 0, '', '', 1, 1, NULL, 0, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
            (41, 'termsandconditions', 'Terms And Conditions', 30, '', 0, NULL, NULL, 2, 0, 0, 0, 0, 1, 0, '', '', 0, 0, NULL, 1, 0, 1, '', 0, 0, 0, 0, 0, '', NULL, NULL),
        ...
        wpjobportal::$_db->query($query);
            ...
            $query = "CREATE TABLE IF NOT EXISTS `" . wpjobportal::$_db->prefix . "wj_portal_jobs` (
              ...
              `workplace_type` tinyint(1) DEFAULT '0',
