...
<div id="wpjobportal-page-quick-actions">
    ...
    <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" confirmmessage="<?php echo esc_attr(__('Are you sure to delete','wp-job-portal')).' ?'; ?>" data-for="removecity" href="#" title="<?php echo esc_attr(__('delete', 'wp-job-portal')); ?>">
    ...
    <div class="wpjobportal-lcoation-pages-link-wrap" >
        <a class="wpjobportal-page-quick-act-btn wpjobportal-import-address-data-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_city&wpjobportallt=loadaddressdata')); ?>" title="<?php echo esc_attr(__('Import Location Data', 'wp-job-portal')); ?>">
            <img src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/import-address-data-icon.png" alt="<?php echo esc_attr(__('Import Location Data', 'wp-job-portal')); ?>" />
            <?php echo esc_html(__('Import Location Data', 'wp-job-portal')); ?>
        </a>
        <a class="wpjobportal-page-quick-act-btn wpjobportal-location-name-settings-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_city&wpjobportallt=locationnamesettings')); ?>" title="<?php echo esc_attr(__('Location Name Settings', 'wp-job-portal')); ?>">
            <img src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/loction-name-settings-icon.png" alt="<?php echo esc_attr(__('Location Name Settings', 'wp-job-portal')); ?>" />
