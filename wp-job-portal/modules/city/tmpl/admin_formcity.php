...
<div id="wpjobportaladmin-wrapper">
    ...
    <div id="wpjobportaladmin-data">
        ...
        <!-- top head -->
        <?php  WPJOBPORTALincluder::getTemplate('templates/admin/pagetitle',array('wpjobportal_module' => 'city', 'wpjobportal_layouts' => 'cityadd')); ?>
        <!-- page content -->
        <div id="wpjobportal-admin-wrapper">
            <?php
            $wpjobportal_token = WPJOBPORTALincluder::getJSModel('common')->getUniqueIdForTransient();
            $wpjobportal_transient_val = get_transient('current_user_token_city_'.$wpjobportal_token);
            if(!empty($wpjobportal_transient_val)){
                ...
                <div class="wpjobportal-admin--backlink-wrap">
                    <a id="form-back-button" class="wpjobportal-form-back-btn" href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_city&wpjobportal_restore_results='.$wpjobportal_token.'&countryid='.$wpjobportal_countryid)); ?>" title="<?php echo esc_attr(__('Back to listing', 'wp-job-portal')); ?>">
