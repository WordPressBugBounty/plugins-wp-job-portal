...
<div class="wpjobportal-form-button">
	<a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_jobstatus')); ?>" title="<?php echo esc_attr(__('cancel', 'wp-job-portal')); ?>">
