...
<tr id="id_<?php echo esc_attr($wpjobportal_row->id);?>">
    ...
    <td class="wpjobportal-text-left">
        <a href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_careerlevel&wpjobportallt=formcareerlevels&wpjobportalid='.$wpjobportal_row->id)); ?>" title="<?php echo esc_attr(__('title','wp-job-portal')). ' : '; ?>">
    ...
    <td>
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_common&task=makedefault&action=wpjobportaltask&for=careerlevels&id='.$wpjobportal_row->id.$wpjobportal_pageid),'wpjobportal_common_entity_nonce')); ?>" title="<?php echo esc_attr(__('not default','wp-job-portal')); ?>">
    ...
    <td>
        <?php if ($wpjobportal_row->status == 1) { ?>
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$wpjobportal_row->id.$wpjobportal_pageid),'wpjobportal_careerlevel_nonce')); ?>" title="<?php echo esc_attr(__('published', 'wp-job-portal')); ?>">
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$wpjobportal_row->id.$wpjobportal_pageid),'wpjobportal_careerlevel_nonce')); ?>" title="<?php echo esc_attr(__('not published', 'wp-job-portal')); ?>">
    ...
    <td>
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_careerlevel&wpjobportallt=formcareerlevels&wpjobportalid='.$wpjobportal_row->id)); ?>" title="<?php echo esc_attr(__('edit', 'wp-job-portal')); ?>">
        ...
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$wpjobportal_row->id),'wpjobportal_careerlevel_nonce')); ?>" onclick='return confirmdelete("<?php echo esc_js(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_attr(__('delete', 'wp-job-portal')); ?>">
