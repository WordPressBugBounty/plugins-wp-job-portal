                ...
                <div class="add-on-page-cnt">
                    ...
                    <div class="add-on-list">
                        ...
                        <div class="add-on-item copy-job">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/copy-job.png" alt="<?php echo esc_attr(__('Copy Job','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/copy-job/ " class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item credits">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/credits.png" alt="<?php echo esc_attr(__('Credits','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/credit-system/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item cron-job">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/cron-job.png" alt="<?php echo esc_attr(__('Credits','wp-job-portal')); ?>" />
                            <div class="add-on-name"><?php echo esc_html(__('Cron Job','wp-job-portal')); ?></div>
                            <div class="add-on-txt"><?php echo esc_html(__('WP Job Portal offers a feature for an employer to copy their jobs. Employers can copy their jobs easily.','wp-job-portal')); ?></div>
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/cron-job-copy/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        ...
                        <div class="add-on-item export">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/export.png" alt="<?php echo esc_attr(__('Export','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/export/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item feat-comp">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/featured-company.png" alt="<?php echo esc_attr(__('Featured Company','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/featured-company/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        ...
                        <div class="add-on-item folders">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/folders.png" alt="<?php echo esc_attr(__('Folder','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/folders/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        ...
                        <div class="add-on-item job-alert">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/job-alert.png" alt="<?php echo esc_attr(__('Job Alert','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/job-alert/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item messages">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/messages.png" alt="<?php echo esc_attr(__('Message','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/messages/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item multi-comp">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/companies.png" alt="<?php echo esc_attr(__('Multi Company','wp-job-portal')); ?>" />
                        ...
                        <div class="add-on-item pdf">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/pdf.png" alt="<?php echo esc_attr(__('PDF','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/pdf/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item print">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/print.png" alt="<?php echo esc_attr(__('Print','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/print/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item reports">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/reports.png" alt="<?php echo esc_attr(__('Reports','wp-job-portal')); ?>" />
                        ...
                        <div class="add-on-item social-login">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/social-login.png" alt="<?php echo esc_attr(__('Social Login','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/social-login/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item social-share">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/social-share.png" alt="<?php echo esc_attr(__('Social Share','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/social-share/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item tags">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/tags.png" alt="<?php echo esc_attr(__('Tag','wp-job-portal')); ?>" />
                        ...
                        <div class="add-on-item themes">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/themes.png" alt="<?php echo esc_attr(__('Themes','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/plugin-color/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item apply-as-vis">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/apply-as-visitor.png" alt="<?php echo esc_attr(__('Visitor Apply Job','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/apply-as-visitor/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                        <div class="add-on-item visi-add-job">
                            <img class="add-on-img" src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/add-on-list/visitor-ad-job.png" alt="<?php echo esc_attr(__('Visitor Add Job','wp-job-portal')); ?>" />
                            ...
                            <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/product/visitor-add-jobs/" class="add-on-btn"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                        </div>
                    </div>
                    <div class="add-on-sec-header">
                    ...
                    <div class="add-on-bundle-pack-list">
                        <div class="add-on-bundle-pack-item basic">
                            ...
                            <div class="add-on-bundle-pack-btn">
                                <a title="<?php echo esc_attr(__('buy now','wp-job-portal')); ?>" href="https://wpjobportal.com/pricing/"><?php echo esc_html(__('buy now','wp-job-portal')); ?></a>
                            </div>
                        </div>
