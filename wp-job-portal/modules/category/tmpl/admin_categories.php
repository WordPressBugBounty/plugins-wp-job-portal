...
wp_add_inline_script( 'wpjobportal-inline-handle', $wpjobportal_inline_js_script );
    ...
    if (!WPJOBPORTALincluder::getTemplate('templates/admin/header',array('wpjobportal_module' => 'category'))){
        return;
    }
?>
<?php 
...
<div id="wpjobportaladmin-wrapper">
    ...
    <div id="wpjobportaladmin-data">
        ...
        <!-- top head -->
        <?php  WPJOBPORTALincluder::getTemplate('templates/admin/pagetitle',array('wpjobportal_module' => 'categories','wpjobportal_layouts' => 'categories')); ?>
        <!-- page content -->
                            ...
                            <tbody>
                                <?php
                                    ...
                                    for ($wpjobportal_i = 0, $wpjobportal_n = count(wpjobportal::$_data[0]); $wpjobportal_i < $wpjobportal_n; $wpjobportal_i++) {
                                        ...
                                        WPJOBPORTALincluder::getTemplate('category/views/main',array('wpjobportal_row' => $wpjobportal_row,'wpjobportal_i' => $wpjobportal_i ,'wpjobportal_pagenum' => $wpjobportal_pagenum ,'wpjobportal_n' => $wpjobportal_n ,'wpjobportal_pageid' => $wpjobportal_pageid ));
                                    }?>
                            </tbody>
                        </table>
