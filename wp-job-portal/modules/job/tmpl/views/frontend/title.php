...
switch ($wpjobportal_layout) {
    case 'job':
            ...
            <div class="wjportal-jobs-middle-wrp">
                ...
                <div class="wjportal-jobs-data">
                    <span class="wjportal-job-title wpjp-job-title-flex">
                    ...
                    <?php
                    if(in_array('joblistingenhancer',wpjobportal::$_active_addons)){
                        $wpjobportal_print = WPJOBPORTALincluder::getJSModel('job')->checkLinks('is_urgent');
            ...
            <div class="wjportal-jobs-right-wrp">
                <div class="wjportal-jobs-info">
                    ...
                    // --- WP Job Portal: Workplace Type Badges ---
                        ...
                        $wpjobportal_print = WPJOBPORTALincluder::getJSModel('job')->checkLinks('workplace_type');
                        if (isset($wpjobportal_print[0]) && $wpjobportal_print[0] == 1) {
        ...
        case 'job_seeker':
            echo ' <div class="wjportal-jobinfo-wrp">'; ?>
                    ...
                    if(isset(wpjobportal::$wpjobportal_data['published_fields']['workplace_type'])){
                        if (isset($wpjobportal_job->workplace_type) && $wpjobportal_job->workplace_type != 0) {
                            $wpjp_badge_label = '';
                            switch ($wpjobportal_job->workplace_type) {
                                case '1': // On-site
                            ...
                            if(!empty($wpjp_badge_label)){
                                echo '<div class="wjportal-jobinfo  wjportal-jobinfo-right-data-workplace-type">
                                        <span class="wjportal-jobinfo-data '. esc_attr($wpjp_badge_class).'" >
                                            <img src="' . esc_url(WPJOBPORTAL_PLUGIN_URL) . 'includes/images/category.png" alt="'.esc_attr(__("Workplace Type",'wp-job-portal')).'" title="'.esc_attr(__("Workplace Type",'wp-job-portal')).'"/>
                                            '.esc_html($wpjp_badge_label) .'
                                        </span>
                                    </div>';
                            }
