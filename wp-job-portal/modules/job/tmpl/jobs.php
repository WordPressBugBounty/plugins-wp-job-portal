...
<div class="wjportal-main-up-wrapper">
    ...
    wpjobportal::$_data['fields_titles_array'] = WPJOBPORTALincluder::getJSModel('fieldordering')->getFieldOrderingData(2);
    ...
    <div class="wjportal-main-wrapper wjportal-clearfix">
        ...
        <div class="wjportal-newest-jobs">
            ...
            if(in_array('joblistingenhancer', wpjobportal::$_active_addons)){ // make sure addon exsists
            $joblisting_ajax_filter_tags = wpjobportal::$_config->getConfigValue('joblisting_ajax_filter_tags');
            $joblisting_ajax_show_sorting = wpjobportal::$_config->getConfigValue('joblisting_ajax_show_sorting');
                if(!empty($joblisting_ajax_filter_tags) || $joblisting_ajax_show_sorting == 1){ // makeing sure some section will be visisble
                    WPJOBPORTALincluder::getTemplate('/frontend/filters', array('module_name'=>'joblistingenhancer'));
                }
            }
            ?>
