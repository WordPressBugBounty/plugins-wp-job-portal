...
?>
	...
	<?php echo wp_kses( WPJOBPORTALformfield::button('advanced_search', esc_html(__('Advanced Search', 'wp-job-portal')), array('class' => 'button wpjobportal-toggle-filter-btn', 'onclick' => 'toggleFilterFields();', 'data-search-title'=>esc_html(__('Advanced Search', 'wp-job-portal')),'data-hide-title'=>esc_html(__('Less Options', 'wp-job-portal')))),WPJOBPORTAL_ALLOWED_TAGS);?>

	<div class="wpjobportal-extra-filter-fields">
