    ...
    case 'airesumesearch':
        ...
        $wpjobportal_html.='<div class="wjportal-filter-ai-searchfrm-wrp">
            ...
            $wpjobportal_html.='    <div class="wjportal-filter-search-btn-wrp">
                ...
                //$wpjobportal_html.='        <span class="wjportal-filter-ai-searchfrm-discription">' . esc_html(__('Start typing what you know – our AI will help you find the best matching resumes.', 'wp-job-portal')) . '</span>';
                $wpjobportal_html.='
                </div>
        </div>';
        $wpjobportal_html .= WPJOBPORTALformfield::hidden('wpjobportallay' , 'resumes');
