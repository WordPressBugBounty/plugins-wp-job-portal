...
<div id="wpjobportaladmin-wrapper">
    ...
    <div id="wpjobportaladmin-data">
        ...
        <!-- top head -->
        <?php
            if (!WPJOBPORTALincluder::getTemplate('templates/admin/pagetitle',array('wpjobportal_module' => 'resume' ,'wpjobportal_layouts' => 'resume' ))){
                return;
            }
        ?>
        <!-- page content -->
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <form class="wpjobportal-filter-form" name="wpjobportalform" id="wpjobportalform" method="post" action="<?php echo esc_url_raw(admin_url("admin.php?page=wpjobportal_resume&wpjobportallt=resumes")); ?>">
                <?php WPJOBPORTALincluder::getTemplate('resume/views/admin/filters',array('wpjobportal_extra' => (int)0 ,'wpjobportal_layout' => 'admin_filter'));?>
            </form>
            <?php
                    ...
                    <form id="wpjobportal-list-form" method="post" action="<?php echo esc_url_raw(admin_url("admin.php?page=wpjobportal_resume")); ?>">
                        <?php
                            foreach ($wpjobportal_resumes AS $wpjobportal_resume) {?>
                                <div id="resume_<?php echo esc_attr($wpjobportal_resume->id); ?>" class="wpjobportal-resume-list">
                                    <div id="item-data">
