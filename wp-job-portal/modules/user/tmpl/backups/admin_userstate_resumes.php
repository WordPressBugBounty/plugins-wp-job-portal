    ...
    <table id="js-table">
        ...
        <tbody>
            ...
            for ($wpjobportal_i = 0, $wpjobportal_n = count(wpjobportal::$_data[0]); $wpjobportal_i < $wpjobportal_n; $wpjobportal_i++) {
                ...
                ?>
                <tr valign="top">
                    <td class="left-row"><?php echo esc_html($wpjobportal_row->first_name) . ' ' . esc_html($wpjobportal_row->last_name); ?></td>
                    <td><?php echo esc_html($wpjobportal_row->application_title); ?>	</td>
                    <td><?php echo esc_html($wpjobportal_row->cat_title); ?>	</td>
                    <td><?php echo esc_html(date_i18n($this->config['date_format'], strtotime($wpjobportal_row->create_date))); ?></td>
