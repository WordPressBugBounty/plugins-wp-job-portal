        ...
        'groups' => [
            ...
            'login_registration' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'jobsloginlogout', 'label' => __('Show Log In/Out Button For Job Seeker', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['jobsloginlogout'], 'tooltip' => __('Show login logout button in job seeker control panel', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno],
                ]
            ],
            'terms_conditions' => [
                'title'       => __('Terms and Conditions', 'wp-job-portal'),
        ...
        'groups' => [
            'registration' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'employe_register_link', 'label' => __('Employer Custom After-Registration Link', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['employe_register_link'], 'tooltip' => __('Custom Employer After Register Link', 'wp-job-portal')],
                ]
            ],
            'dashboard_layout' => [
        ...
        'groups' => [
            'registration' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'jobseeker_register_link', 'label' => __('Job Seeker Custom After-Registration Link', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['jobseeker_register_link'], 'tooltip' => __('Custom Job seeker After Register Link', 'wp-job-portal')],
                    ['id' => 'allow_jobshortlist', 'label' => __('Enable Job Shortlisting', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['allow_jobshortlist'], 'tooltip' => __('Allow job seekers to shortlist jobs', 'wp-job-portal') . '. ' . __('This affects the job detail page', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno , 'pro' => ['slug' => 'shortlist', 'name' => __('Shortlist Jobs', 'wp-job-portal')]],
                    ['id' => 'allow_tellafriend', 'label' => __('Enable', 'wp-job-portal') .' '. __('Tell A Friend', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['allow_tellafriend'], 'tooltip' => __('Enable', 'wp-job-portal') . ' ' . __('Tell A Friend', 'wp-job-portal') . ' ' . __('feature on job listing pages', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno , 'pro' => ['slug' => 'tellfriend', 'name' => __('Tell A Friend', 'wp-job-portal')]],
                ]
            ],
            'dashboard_layout' => [
                'title'       => __('Dashboard', 'wp-job-portal') . ' ' . __('Layout & Widgets', 'wp-job-portal'),
         ...
         'groups' => [
                 ...
                 'employer_dashboard_links' => [
                         ...
                         'fields'            => [
                                 ...
                                 ['id' => 'vis_emmy_resumesearches', 'label' => __('Visitor Show Saved Searches', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['vis_emmy_resumesearches'], 'tooltip' => __('Allow Visitors to save their resume searches', 'wp-job-portal'), 'options' => $wpjobportal_options_showhide, 'pro' => ['slug' => 'resumesearch', 'name' => __('Resume Search', 'wp-job-portal')]],
                 ...
                 'jobseeker_dashboard_links' => [
                         ...
                         'fields'            => [
                                 ...
                                 ['id' => 'vis_jsratelist', 'label' => __("Visitor Show", 'wp-job-portal') . ' ' . __('My Subscriptions','wp-job-portal') . ' ' . __('Link', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['vis_jsratelist'], 'options' => $wpjobportal_options_showhide, 'pro' => ['slug' => 'credits', 'name' => __('Credits', 'wp-job-portal')]],
                         ]
                 ],
    ...
    'jobs' => [
        ...
        'groups' => [
            'posting' => [
                ...
                'description' => __('Manage how jobs are posted, their life cycle, and related features', 'wp-job-portal'),
                'fields'      => [
            ...
            'display' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'jobtype_per_row', 'label' => __('Job Types Per Row', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['jobtype_per_row'], 'tooltip' => __('How many job types to display per row on the', 'wp-job-portal') . ' ' . __('Jobs By Types', 'wp-job-portal') . ' ' . __('page', 'wp-job-portal')],
                ]
            ],
            ...
            'ajax_filters' => [
                ...
                'pro'         => ['slug' => 'joblistingenhancer', 'name' => __('Job Listing Enhancer', 'wp-job-portal')],
                'fields'      => [
        ...
        'groups' => [
            ...
            'files' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'max_resume_employers', 'label' => __('Max Employers in Resume Builder', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['max_resume_employers'], 'tooltip' => __('Maximum number of employers allowed in the resume builder', 'wp-job-portal'), 'pro' => ['slug' => 'advanceresumebuilder', 'name' => __('Advanced Resume Builder', 'wp-job-portal')]],
                    ['id' => 'max_resume_institutes', 'label' => __('Max Institutes in Resume Builder', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['max_resume_institutes'], 'tooltip' => __('Maximum number of institutes allowed in the resume builder', 'wp-job-portal'), 'pro' => ['slug' => 'advanceresumebuilder', 'name' => __('Advanced Resume Builder', 'wp-job-portal')]],
                    ['id' => 'max_resume_languages', 'label' => __('Max Languages in Resume Builder', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['max_resume_languages'], 'tooltip' => __('Maximum number of languages allowed in the resume builder', 'wp-job-portal'), 'pro' => ['slug' => 'advanceresumebuilder', 'name' => __('Advanced Resume Builder', 'wp-job-portal')]],
                    ['id' => 'max_resume_addresses', 'label' => __('Max Addresses in Resume Builder', 'wp-job-portal'), 'type' => 'text', 'value' => wpjobportal::$_data[0]['max_resume_addresses'], 'tooltip' => __('Maximum number of addresses allowed in the resume builder', 'wp-job-portal'), 'pro' => ['slug' => 'advanceresumebuilder', 'name' => __('Advanced Resume Builder', 'wp-job-portal')]],
                ]
            ]
        ]
    ],
        ...
        'groups' => [
            ...
            'social_login' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'loginwithlinkedin', 'label' => __('Login With Linkedin', 'wp-job-portal')
, 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['loginwithlinkedin'], 'tooltip' => __('Allow users to log in using their LinkedIn account', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno],
            ...
            */
            'social_sharing' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'employer_share_twitter_share', 'label' => __('Enable X(Twitter) Share', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['employer_share_twitter_share'], 'tooltip' => __('Show Twitter share button', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno],
            ...
            'mapping' => [
                'title'       => __('Mapping & Geo Location', 'wp-job-portal'),
        ...
        'groups' => [
            ...
            'dashboard_links' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'jsratelist', 'label' => __('Job Seeker', 'wp-job-portal') . ' ' . __('Show', 'wp-job-portal') . ' ' . __('My Subscriptions','wp-job-portal') . ' ' . __('Link', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['jsratelist'], 'tooltip' => __("Show a link to active subscriptions in the job seeker's dashboard", 'wp-job-portal'), 'options' => $wpjobportal_options_showhide],
