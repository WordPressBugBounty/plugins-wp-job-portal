        ...
        'groups' => [
            'registration' => [
                ...
                'fields'      => [
                    ...
                    ['id' => 'allow_tellafriend', 'label' => __('Enable', 'wp-job-portal') .' '. __('Tell A Friend', 'wp-job-portal'), 'type' => 'toggle', 'value' => wpjobportal::$_data[0]['allow_tellafriend'], 'tooltip' => __('Enable', 'wp-job-portal') . ' ' . __('Tell A Friend', 'wp-job-portal') . ' ' . __('feature on job listing pages', 'wp-job-portal'), 'options' => $wpjobportal_options_yesno],
                ]
            ],
            'dashboard_layout' => [
                'title'       => __('Dashboard', 'wp-job-portal') . ' ' . __('Layout & Widgets', 'wp-job-portal'),
