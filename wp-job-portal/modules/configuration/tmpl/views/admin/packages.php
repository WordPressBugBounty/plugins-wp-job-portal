...
<div id="listjobs">
    ...
    <div class="left">
        <div class="js-col-xs-12 js-col-md-12 js-job-configuration-row">
            ...
            <div class="js-col-xs-12  js-job-configuration-description"><small><?php echo esc_html(__('Show featured jobs in jobs listing page', 'wp-job-portal')); ?></small></div>
        </div>
        <div class="js-col-xs-12 js-col-md-12 js-job-configuration-row">
            ...
            <div class="js-col-xs-12  js-job-configuration-description"><small><?php echo esc_html(__('Show total number of jobs in jobs listing page', 'wp-job-portal')); ?></small></div>
        </div>
    </div>
    <div class="right">
        <div class="js-col-xs-12 js-col-md-12 js-job-configuration-row">
        ...
        <div class="js-col-xs-12 js-col-md-12 js-job-configuration-row">
            ...
            <div class="js-col-xs-12  js-job-configuration-value"><?php echo wp_kses(WPJOBPORTALformfield::text('careerbuilder_emptype', wpjobportal::$_data[0]['careerbuilder_emptype'], array('class' => 'inputbox')),WPJOBPORTAL_ALLOWED_TAGS); ?>
                <div>
                    ...
                    <small>JTFP : <?php echo esc_html(__('Full-Time', 'wp-job-portal') .'/'. __('Part-time', 'wp-job-portal')); ?></small><br/>
