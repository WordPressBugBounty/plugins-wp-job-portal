...
<tr>
    ...
    <td>
        <a href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_city&stateid='.esc_attr($wpjobportal_row->id).'&countryid='.esc_attr($wpjobportal_row->countryid))); ?>" title="<?php echo esc_attr(__('cities', 'wp-job-portal')); ?>">
    ...
    <td>
        ...
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_state&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$wpjobportal_row->id),'wpjobportal_state_nonce')); ?>" onclick='return confirmdelete("<?php echo esc_js(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_attr(__('delete', 'wp-job-portal')); ?>">
