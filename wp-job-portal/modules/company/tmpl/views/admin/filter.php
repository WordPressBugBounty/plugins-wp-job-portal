...
<?php
    ...
    switch ($wpjobportal_layouts) {
        ...
        break;
        case 'comp-filter':
            $wpjobportal_html.= WPJOBPORTALformfield::text('searchcompany', wpjobportal::$_data['filter']['searchcompany'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Company Name', 'wp-job-portal'))));
            ...
            //$wpjobportal_html.='<span id="showhidefilter"><img src='. esc_url(WPJOBPORTAL_PLUGIN_URL).'includes/images/filter-down.png></span>';
        break;
        case 'que-filter':
            $wpjobportal_html.= WPJOBPORTALformfield::text('searchcompany', wpjobportal::$_data['filter']['searchcompany'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Company Name', 'wp-job-portal'))));
            // this filter is not valid
            //$wpjobportal_html.= WPJOBPORTALformfield::select('searchjobcategory', WPJOBPORTALincluder::getJSModel('category')->getCategoriesForCombo(), wpjobportal::$_data['filter']['searchjobcategory'], esc_html(__('Select','wp-job-portal')) .' '. esc_html(__('Category', 'wp-job-portal')), array('class' => 'inputbox wpjobportal-form-select-field'));
            $wpjobportal_html.= WPJOBPORTALformfield::text('datestart', wpjobportal::$_data['filter']['datestart'], array('class' => 'custom_date wpjobportal-form-input-field', 'placeholder' => esc_html(__('Date Start', 'wp-job-portal')), 'autocomplete' => 'off'));
            $wpjobportal_html.= WPJOBPORTALformfield::text('dateend', wpjobportal::$_data['filter']['dateend'], array('class' => 'custom_date wpjobportal-form-input-field', 'placeholder' => esc_html(__('Date End', 'wp-job-portal')), 'autocomplete' => 'off'));
            $wpjobportal_html.= WPJOBPORTALformfield::hidden('WPJOBPORTAL_form_search', 'WPJOBPORTAL_SEARCH');
            $wpjobportal_html.= WPJOBPORTALformfield::submitbutton('btnsubmit', esc_html(__('Search', 'wp-job-portal')), array('class' => 'button wpjobportal-form-search-btn'));
