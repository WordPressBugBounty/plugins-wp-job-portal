	...
	case 'control': ?>
		<div id="item-actions" class="wpjobportal-company-action-wrp">
			<?php
				...
				*/
				do_action('wpjobportal_addons_control_company_admin',$wpjobportal_company);
			?>
			...
			<div class="wpjobportal-company-action-wrp">
			    ...
			    <?php
			        ...
			        /*}
			            ...
			            ?>
			            <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="approveActionPopup('<?php echo esc_js($wpjobportal_company->id); ?>');"><img src="<?php echo esc_url(WPJOBPORTAL_PLUGIN_URL); ?>includes/images/publish-icon.png">  <?php echo esc_html(__('Approve', 'wp-job-portal')); ?>
			                <div id="wpjobportal-queue-actionsbtn" class="jobsqueueapprove_<?php echo esc_attr($wpjobportal_company->id); ?>">
			                    <?php if (isset($wpjobportal_arr['self'])) { ?>
			                        <a id="wpjobportal-act-row" class="wpjobportal-act-row" href="admin.php?page=wpjobportal_company&task=approveQueueCompany&id=<?php echo esc_attr($wpjobportal_company->id); ?>&action=wpjobportaltask">
					...
					/*} else {
					    ?>
					    <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="rejectActionPopup('<?php echo esc_js($wpjobportal_company->id); ?>');">
