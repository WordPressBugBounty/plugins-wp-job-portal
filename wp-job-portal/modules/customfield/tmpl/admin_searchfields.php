    ...
    <div id="wpjobportaladmin-data">
        ...
        <div id="popup_main" style="display:none;">
            <span class="popup-top">
                ...
                <img id="popup_cross" alt="<?php echo esc_attr(__('popup close','wp-job-portal')); ?>" title="<?php echo esc_attr(__('popup close','wp-job-portal')); ?>" onClick="closePopup();" src="<?php echo  esc_url(WPJOBPORTAL_PLUGIN_URL);?>includes/images/popup-close.png">
            </span>
            ...
            <?php if (!empty(wpjobportal::$_data[0])) { ?>
                <form  id="wpjobportal-form" class="search-fields-form wpjobportal-form" method="post" action="<?php echo esc_url_raw(admin_url("admin.php?page=wpjobportal_fieldordering&action=wpjobportaltask&task=savesearchfieldorderingFromForm")); ?>">
                    ...
                    <div class="wpjobportal-filter-form-action-wrp">
                        <a class="wpjobportal-form-canc-btn" id="form-cancel-button" href="<?php echo esc_url_raw(admin_url('admin.php?page=wpjobportal_fieldordering&ff='.esc_attr(wpjobportal::$wpjobportal_data['fieldfor']))); ?>" title="<?php echo esc_attr(__('cancel', 'wp-job-portal')); ?>">
